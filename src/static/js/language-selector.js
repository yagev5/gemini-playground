const languages = [
    { name: 'English (US)', code: 'en-US', file: 'en' },
    { name: 'Mandarin Chinese (China)', code: 'cmn-CN', file: 'zh' },
    { name: 'English (Australia)', code: 'en-AU', file: 'en' },
...
async function setLanguage(langCode) {
    const language = getLanguage(langCode) || languages[0];
    const langFile = language.file || 'en';
